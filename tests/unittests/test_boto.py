...
class TestBotoFuncs(unittest.TestCase):
    ...
    def test_file_uploaded(self) -> None:
        ...
        s3.upload_file(self.bucket_name, self.json_name, join(self.fixtures_folder, self.json_name))
        for key in self.bucket.objects.all():
    ...
    def test_downloaded_file_exists(self) -> None:
        ...
        s3.download_file(self.bucket_name, self.json_name, self.fixtures_folder)
